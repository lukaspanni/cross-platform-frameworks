...
%TODO: neue Architektur wurde verwendet
...
% TODO: scheint verbreitet zu sein https://stackoverflow.com/questions/73956948/react-native-ios-too-big-app-when-hermes-is-enabled, https://github.com/facebook/react-native/issues/31324  https://github.com/facebook/hermes/issues/499
% eventuell zusätzlich die installierte Größe messen
% unter iOS ist ipa größe nicht unbedingt die installierte Größe, beim Upload zum App-Store werden spezifische .ipas generiert, welche ausgeliefert werden und deutlich kleiner sein können.
...
%TODO: neue Architektur von React Native ist offensichtliche deutlich effizienter beim Hardwarezugriff als Flutter, kein Vergleich mit alter Architektur möglich, da Plugin nur für neue verfügbar
\begin{figure}[ht]
  \centering 
